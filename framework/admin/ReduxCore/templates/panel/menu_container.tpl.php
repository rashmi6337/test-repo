...
<?php
        foreach ( $this->parent->sections as $k => $section ) {
            ...
            if ( false == $skip_sec ) {
                /* modified by minti. section_menu is already escaped */
                $redux_theme_options_li_escaped = $this->parent->section_menu ( $k, $section );
                echo $redux_theme_options_li_escaped; // WPCS: xss ok.
                /* end mod */
                $skip_sec = false;
            }
        }
