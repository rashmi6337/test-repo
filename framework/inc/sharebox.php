...
<div class="sharebox clearfix">
	<ul>
		...
		<li>
			<a href="http://twitter.com/home?status=<?php the_title(); ?> <?php the_permalink(); ?>" class="share-twitter" target="_blank" title="<?php _e( 'Share via', 'unicon' ) ?> <?php _e( 'Twitter', 'unicon' ) ?>"><i class="fa fa-twitter"></i> <?php _e( 'Twitter', 'unicon' ) ?></a>
		</li>
		<?php } ?>
		<?php if($minti_data['check_sharebox']['tumblr'] == '1') { ?>	
		<li>
			<a href="http://www.reddit.com/submit?url=<?php the_permalink() ?>&amp;title=<?php echo urlencode(esc_attr(the_title('', '', false))); ?>" class="share-tumblr" target="_blank" title="<?php _e( 'Share via', 'unicon' ) ?> <?php _e( 'Tumblr', 'unicon' ) ?>"><i class="fa fa-tumblr"></i> <?php _e( 'Tumblr', 'unicon' ) ?></a>
		</li>
		<?php } ?>
